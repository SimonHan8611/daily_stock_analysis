...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "AUTO_HISTORY_ANALYSIS_ENABLED": {
        "title": "Auto History Analysis",
        "description": "Run one daily analysis task for each distinct stock in analysis history.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AUTO_HISTORY_ANALYSIS_TIME": {
        "title": "Auto History Analysis Time",
        "description": "Daily auto history analysis trigger time in HH:MM format.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "AUTO_HISTORY_ANALYSIS_LIMIT": {
        "title": "Auto History Analysis Limit",
        "description": "Maximum number of recently analyzed distinct stocks per scheduled run.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "AUTO_HISTORY_ANALYSIS_REPORT_TYPE": {
        "title": "Auto History Analysis Report Type",
        "description": "Report type used by auto history analysis tasks.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": ["simple", "detailed", "full", "brief"],
        "validation": {"enum": ["simple", "detailed", "full", "brief"]},
        "display_order": 15,
    },
    "AUTO_HISTORY_ANALYSIS_NOTIFY": {
        "title": "Auto History Analysis Notify",
        "description": "Whether auto history analysis tasks send notifications.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
