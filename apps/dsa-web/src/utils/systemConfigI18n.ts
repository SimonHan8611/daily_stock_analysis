...
const fieldTitleMap: Record<string, string> = {
  ...
  AUTO_HISTORY_ANALYSIS_ENABLED: '启用历史股票自动分析',
  AUTO_HISTORY_ANALYSIS_TIME: '历史股票自动分析时间',
  AUTO_HISTORY_ANALYSIS_LIMIT: '历史股票自动分析数量',
  AUTO_HISTORY_ANALYSIS_REPORT_TYPE: '历史股票自动分析报告类型',
  AUTO_HISTORY_ANALYSIS_NOTIFY: '历史股票自动分析通知',
  DEBUG: '调试模式',
  HTTP_PROXY: 'HTTP 代理',
  LOG_DIR: '日志目录',
  LOG_LEVEL: '日志级别',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  AUTO_HISTORY_ANALYSIS_ENABLED: '开启后，API 服务会每天按指定时间自动分析最近历史记录中的去重股票。',
  AUTO_HISTORY_ANALYSIS_TIME: '历史股票自动分析触发时间，格式为 HH:MM，默认 14:45。',
  AUTO_HISTORY_ANALYSIS_LIMIT: '每次最多分析最近历史记录里的多少只去重股票，默认 20。',
  AUTO_HISTORY_ANALYSIS_REPORT_TYPE: '自动分析任务使用的报告类型，默认 detailed。',
  AUTO_HISTORY_ANALYSIS_NOTIFY: '开启后，历史股票自动分析任务会发送通知；默认关闭，避免批量通知打扰。',
