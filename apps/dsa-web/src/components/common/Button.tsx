...
const MANTINE_VARIANT_MAP = {
  primary: 'filled',
  secondary: 'default',
  'settings-primary': 'filled',
  'settings-secondary': 'default',
  outline: 'outline',
  ghost: 'subtle',
  gradient: 'gradient',
  danger: 'filled',
  ...
  'action-secondary': 'subtle',
  'home-action-ai': 'subtle',
  'home-action-report': 'subtle',
} as const;

const MANTINE_SIZE_MAP = {
  xsm: 'compact-xs',
  sm: 'sm',
  md: 'md',
  lg: 'lg',
...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <MantineButton
      type={type}
      variant={MANTINE_VARIANT_MAP[variant]}
      size={MANTINE_SIZE_MAP[size]}
      loading={isLoading}
